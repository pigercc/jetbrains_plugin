...
# 背景
通过编译，我们已经有现成的 sweepai-1.29.3.zip 文件了，直接撞到idea plugin 本地安装就完事了
接下来，我们安装中间服务器，和启动大模型
...
```
/home/data/sweep/start.sh
```
export NEXT_EDIT_AUTOCOMPLETE_ENDPOINT=http://192.168.31.103:1234
uvx sweep-autocomplete --port 8081
```
